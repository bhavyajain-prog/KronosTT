...
class ConstraintPropagationAlgoTest {
    // Test volume
    ...
    void testLargeScaleTimeTableGeneration() {
        ...
        // 4. Output Statistics
        System.out.println("=== CONSTRAINT PROPAGATION STRESS TEST RESULTS ===");
    ...
    private List<Room> generateRooms() {
        ...
        for (long i = 0; i < ConstraintPropagationAlgoTest.NUM_ROOMS; i++) {
    ...
    private List<Subject> generateSubjects() {
        ...
        for (long i = 0; i < ConstraintPropagationAlgoTest.NUM_SUBJECTS; i++) {
    ...
    private List<Teacher> generateTeachers(List<Subject> subjects) {
        ...
        for (int i = 0; i < ConstraintPropagationAlgoTest.NUM_TEACHERS; i++) {
    ...
    private List<Batch> generateBatches(List<Subject> allSubjects) {
        ...
        for (long i = 0; i < ConstraintPropagationAlgoTest.NUM_BATCHES; i++) {
